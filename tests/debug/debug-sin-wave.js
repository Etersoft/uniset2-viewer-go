...
(async () => {
    ...
    console.log('=== Sin Wave Generator Test (New Implementation) ===\n');
    ...
    console.log('Opening sin generator dialog...\n');
    ...
    console.log('Comparing values to expected sine wave:\n');
    ...
    for (let i = 0; i <= 20; i++) {
        ...
        const expectedWave = Math.sin(phase);
    ...
    console.log('\n');
    if (errors.length === 0) {
        console.log('✓ All values match expected sine wave pattern!');
        console.log('✓ Sin generator produces smooth sine wave from min to max');
    } else {
