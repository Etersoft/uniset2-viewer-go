...
func TestNewInstance(t *testing.T) {
	...
	instance := NewInstance(cfg, store, time.Second, time.Hour, "TestSupplier", nil, nil, nil, nil)
...
func TestInstanceGetStatus(t *testing.T) {
	...
	store := storage.NewMemoryStorage()
	instance := NewInstance(cfg, store, time.Second, time.Hour, "", nil, nil, nil, nil)
...
func TestInstanceUpdateStatus(t *testing.T) {
	...
	instance := NewInstance(cfg, store, time.Second, time.Hour, "", nil, nil, statusCallback, nil)
...
func TestInstanceStartStop(t *testing.T) {
	...
	store := storage.NewMemoryStorage()
	instance := NewInstance(cfg, store, 100*time.Millisecond, time.Hour, "", nil, nil, nil, nil)
...
func TestInstanceHealthCheckUpdatesStatus(t *testing.T) {
	...
	instance := NewInstance(cfg, store, 50*time.Millisecond, time.Hour, "", nil, nil, statusCallback, nil)
...
func TestInstanceObjectsCallbackOnReconnect(t *testing.T) {
	...
	instance := NewInstance(cfg, store, 50*time.Millisecond, time.Hour, "", nil, nil, nil, objectsCallback)
